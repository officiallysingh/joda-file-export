...
/**
 * <a href="http://en.wikipedia.org/wiki/ISO_3166-1">ISO 3166-1</a> country
 * code.
 *
 * <p>
 * Enum names of this enum themselves are represented by
 * <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1
 * alpha-2</a> code (2-letter upper-case alphabets). There are instance methods
 * to get the country name ({@link #getName()}), the
 * <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >ISO 3166-1
 * alpha-3</a> code ({@link #getAlpha3()}) and the
 * <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric">ISO 3166-1
 * numeric</a> code ({@link #getNumeric()}). In addition, there are static
 * methods to get a {@code CountryCode} instance that corresponds to a given
 * alpha-2/alpha-3/numeric code ({@link #getByCode(String)},
 * {@link #getByCode(int)}).
 * </p>
 *
 * <pre style="background-color: #EEEEEE; margin-left: 2em; margin-right: 2em;
 * border: 1px solid black; padding: 0.5em;">
 * <span style="color: darkgreen;">// List all the country codes.</span>
 * for (CountryCode code : CountryCode.values())
 * {
 *     <span style=
"color: darkgreen;">// For example, "[US] United States" is printed.</span>
 *     System.out.format(<span style=
"color: darkred;">"[%s] %s\n"</span>, code, code.{@link #getName()});
 * }
 *
 * <span style=
"color: darkgreen;">// Get a CountryCode instance by ISO 3166-1 code.</span>
 * CountryCode code = CountryCode.{@link #getByCode(String) getByCode}(<span style
="color: darkred;">"JP"</span>);
 *
 * <span style=
"color: darkgreen;">// Print all the information. Output will be:</span>
 ...
 * <span style=
"color: darkgreen;">//     Assignment state        = OFFICIALLY_ASSIGNED</span>
 * <span style="color: darkgreen;">//</span>
 * System.out.println(<span style=
"color: darkred;">"Country name            = "</span> + code.{@link #getName()});
 * System.out.println(<span style=
"color: darkred;">"ISO 3166-1 alpha-2 code = "</span> + code.{@link #getAlpha2()});
 * System.out.println(<span style=
"color: darkred;">"ISO 3166-1 alpha-3 code = "</span> + code.{@link #getAlpha3()});
 * System.out.println(<span style=
"color: darkred;">"ISO 3166-1 numeric code = "</span> + code.{@link #getNumeric()});
 * System.out.println(<span style=
"color: darkred;">"Assignment state        = "</span> + code.{@link #getAssignment()});
 *
 * <span style="color: darkgreen;">// Convert to a Locale instance.</span>
 * {@link Locale} locale = code.{@link #toLocale()};
 *
 * <span style=
"color: darkgreen;">// Get a CountryCode by a Locale instance.</span>
 ...
 *
 * <span style=
"color: darkgreen;">// Get a list by a regular expression for names.
 * //
 ...
 * //</span>
 * List&lt;CountryCode&gt; list = CountryCode.{@link #findByName(String) findByName}(<span style
="color: darkred;">".*United.*"</span>);
 *
 ...
 * //
 * //     <a href=
"https://en.wikipedia.org/wiki/ISO_3166-3#ANHH">ANHH</a> : CountryCode.AN
 * //     <a href=
"https://en.wikipedia.org/wiki/ISO_3166-3#BUMM">BUMM</a> : CountryCode.BU
 * //     <a href=
"https://en.wikipedia.org/wiki/ISO_3166-3#CSXX">CSXX</a> : CountryCode.CS
 * //     <a href=
"https://en.wikipedia.org/wiki/ISO_3166-3#NTHH">NTHH</a> : CountryCode.NT
 * //     <a href=
"https://en.wikipedia.org/wiki/ISO_3166-3#TPTL">TPTL</a> : CountryCode.TP
 * //     <a href=
"https://en.wikipedia.org/wiki/ISO_3166-3#YUCS">YUCS</a> : CountryCode.YU
 * //     <a href=
"https://en.wikipedia.org/wiki/ISO_3166-3#ZRCD">ZRCD</a> : CountryCode.ZR
 * //</span>
 * code = CountryCode.{@link #getByCode(String) getByCode}(<span style=
"color: darkred;">"ANHH"</span>);
 * </pre>
 *
 */
public enum CountryCode {
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AC">AC</a>, ASC,
	 * -1, Exceptionally reserved]
	 */
	AC("Ascension Island", "ASC", -1, Assignment.EXCEPTIONALLY_RESERVED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Andorra">Andorra</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AD">AD</a>, AND,
	 * 16, Officially assigned]
	 */
	 ...
	 * Emirates</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AE">AE</a>, AE,
	 * 784, Officially assigned]
	 */
	 ...
	 * Barbuda</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AG">AG</a>, ATG,
	 * 28, Officially assigned]
	 */
	AG("Antigua and Barbuda", "ATG", 28, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Anguilla">Anguilla</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AI">AI</a>, AIA,
	 * 660, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AM">AM</a>, ARM,
	 * 51, Officially assigned]
	 */
	 ...
	 * Antilles</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AN">AN</a>, ANT,
	 * 530, Traditionally reserved]
	 *
	 * <p>
	 * Since version 1.16, the value of alpha-3 code of this entry is {@code ANT}
	 * (not <code><a href=
	 * "http://en.wikipedia.org/wiki/ISO_3166-3#ANHH">ANHH</a></code>).
	 * </p>
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AO">AO</a>, AGO,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AQ">AQ</a>, ATA,
	 * 10, Officially assigned]
	 */
	AQ("Antarctica", "ATA", 10, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Argentina">Argentina</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AR">AR</a>, ARG,
	 * 32, Officially assigned]
	 */
	AR("Argentina", "ARG", 32, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/American_Samoa">American Samoa</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AS">AS</a>, ASM,
	 * 16, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AT">AT</a>, AUT,
	 * 40, Officially assigned]
	 */
	AT("Austria", "AUT", 40, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Australia">Australia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AU">AU</a>, AUS,
	 * 36, Officially assigned]
	 */
	AU("Australia", "AUS", 36, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Aruba">Aruba</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AW">AW</a>, ABW,
	 * 533, Officially assigned]
	 */
	 ...
	 * Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AX">AX</a>, ALA,
	 * 248, Officially assigned]
	 *
	 * <p>
	 * The country name was changed from "\u212Bland Islands" (up to 1.14) to
	 * "\u00C5land Islands" (since 1.15).
	 * </p>
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#AZ">AZ</a>, AZE,
	 * 31, Officially assigned]
	 */
	 ...
	 * Barth&eacute;lemy</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BL">BL</a>, BLM,
	 * 652, Officially assigned]
	 */
	BL("Saint Barth\u00E9lemy", "BLM", 652, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Bermuda">Bermuda</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BM">BM</a>, BMU,
	 * 60, Officially assigned]
	 */
	BM("Bermuda", "BMU", 60, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Brunei">Brunei Darussalam</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BN">BN</a>, BRN,
	 * 96, Officially assigned]
	 */
	BN("Brunei Darussalam", "BRN", 96, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Bolivia">Bolivia, Plurinational State
	 * of</a> [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BO">BO</a>,
	 * BOL, 68, Officially assigned]
	 */
	BO("Bolivia, Plurinational State of", "BOL", 68, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Caribbean_Netherlands">Bonaire, Sint
	 * Eustatius and Saba</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BQ">BQ</a>, BES,
	 * 535, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BR">BR</a>, BRA,
	 * 76, Officially assigned]
	 */
	BR("Brazil", "BRA", 76, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/The_Bahamas">Bahamas</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BS">BS</a>, BHS,
	 * 44, Officially assigned]
	 */
	BS("Bahamas", "BHS", 44, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Bhutan">Bhutan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BT">BT</a>, BTN,
	 * 64, Officially assigned]
	 */
	BT("Bhutan", "BTN", 64, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Burma">Burma</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BU">BU</a>, BUMM,
	 * 104, Officially assigned]
	 *
	 * <p>
	 * Since version 1.16, the value of alpha-3 code of this entry is {@code BUR}
	 * (not <code><a href=
	 * "http://en.wikipedia.org/wiki/ISO_3166-3#BUMM">BUMM</a></code>).
	 * </p>
	 *
	 * @see #MM
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BV">BV</a>, BVT,
	 * 74, Officially assigned]
	 */
	BV("Bouvet Island", "BVT", 74, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Botswana">Botswana</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BW">BW</a>, BWA,
	 * 72, Officially assigned]
	 */
	BW("Botswana", "BWA", 72, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Belarus">Belarus</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BY">BY</a>, BLR,
	 * 112, Officially assigned]
	 */
	BY("Belarus", "BLR", 112, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Belize">Belize</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#BZ">BZ</a>, BLZ,
	 * 84, Officially assigned]
	 */
	BZ("Belize", "BLZ", 84, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Canada">Canada</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CA">CA</a>, CAN,
	 * 124, Officially assigned]
	 */
	 ...
	 * (Keeling) Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CC">CC</a>, CCK,
	 * 166, Officially assigned]
	 */
	CC("Cocos (Keeling) Islands", "CCK", 166, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Democratic_Republic_of_the_Congo">Congo, the
	 * Democratic Republic of the</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CD">CD</a>, COD,
	 * 180, Officially assigned]
	 *
	 * @see #ZR
	 */
	 ...
	 * African Republic</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CF">CF</a>, CAF,
	 * 140, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CG">CG</a>, COG,
	 * 178, Officially assigned]
	 */
	CG("Congo", "COG", 178, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Switzerland">Switzerland</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CH">CH</a>, CHE,
	 * 756, Officially assigned]
	 */
	 ...
	 * d'Ivoire</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CI">CI</a>, CIV,
	 * 384, Officially assigned]
	 */
	CI("C\u00F4te d'Ivoire", "CIV", 384, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Cook_Islands">Cook Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CK">CK</a>, COK,
	 * 184, Officially assigned]
	 */
	CK("Cook Islands", "COK", 184, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Chile">Chile</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CL">CL</a>, CHL,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CM">CM</a>, CMR,
	 * 120, Officially assigned]
	 */
	CM("Cameroon", "CMR", 120, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/China">China</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CN">CN</a>, CHN,
	 * 156, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CO">CO</a>, COL,
	 * 170, Officially assigned]
	 */
	CO("Colombia", "COL", 170, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Clipperton_Island">Clipperton
	 * Island</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CP">CP</a>, CPT,
	 * -1, Exceptionally reserved]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CR">CR</a>, CRI,
	 * 188, Officially assigned]
	 */
	CR("Costa Rica", "CRI", 188, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Serbia_and_Montenegro">Serbia and
	 * Montenegro</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#CS">CS</a>, SCG,
	 * 891, Traditionally reserved]
	 *
	 * <p>
	 * Since version 1.16, the value of alpha-3 code of this entry is {@code SCG}
	 * (not <code><a href=
	 * "http://en.wikipedia.org/wiki/ISO_3166-3#CSXX">CSXX</a></code>).
	 * </p>
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#DG">DG</a>, DGA,
	 * -1, Exceptionally reserved]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#DJ">DJ</a>, DJI,
	 * 262, Officially assigned]
	 */
	DJ("Djibouti", "DJI", 262, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Denmark">Denmark</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#DK">DK</a>, DNK,
	 * 208, Officially assigned]
	 */
	DK("Denmark", "DNK", 208, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Dominica">Dominica</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#DM">DM</a>, DMA,
	 * 212, Officially assigned]
	 */
	 ...
	 * Republic</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#DO">DO</a>, DOM,
	 * 214, Officially assigned]
	 */
	DO("Dominican Republic", "DOM", 214, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Algeria">Algeria</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#DZ">DZ</a>, DZA,
	 * 12, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#EA">EA</a>, null,
	 * -1, Exceptionally reserved]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#FI">FI</a>, FIN,
	 * 246, Officially assigned]
	 *
	 * @see #SF
	 */
	 ...
	 * (Malvinas)</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#FK">FK</a>, FLK,
	 * 238, Officially assigned]
	 */
	FK("Falkland Islands (Malvinas)", "FLK", 238, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Federated_States_of_Micronesia">Micronesia,
	 * Federated States of</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#FM">FM</a>, FSM,
	 * 583, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#FO">FO</a>, FRO,
	 * 234, Officially assigned]
	 */
	FO("Faroe Islands", "FRO", 234, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/France">France</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#FR">FR</a>, FRA,
	 * 250, Officially assigned]
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Metropolitan_France">France,
	 * Metropolitan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#FX">FX</a>, FXX,
	 * 249, Exceptionally reserved]
	 *
	 * <p>
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GA">GA</a>, GAB,
	 * 266, Officially assigned]
	 */
	GA("Gabon", "GAB", 266, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/United_Kingdom">United Kingdom</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GB">GB</a>, GBR,
	 * 826, Officially assigned]
	 *
	 * @see #UK
	 */
	 ...
	 * Guinea</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GQ">GQ</a>, GNQ,
	 * 226, Officially assigned]
	 */
	GQ("Equatorial Guinea", "GNQ", 226, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Greece">Greece</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GR">GR</a>, GRC,
	 * 300, Officially assigned]
	 */
	GR("Greece", "GRC", 300, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/South_Georgia_and_the_South_Sandwich_Islands">South
	 * Georgia and the South Sandwich Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GS">GS</a>, SGS,
	 * 239, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GT">GT</a>, GTM,
	 * 320, Officially assigned]
	 */
	GT("Guatemala", "GTM", 320, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Guam">Guam</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GU">GU</a>, GUM,
	 * 316, Officially assigned]
	 */
	GU("Guam", "GUM", 316, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Guinea-Bissau">Guinea-Bissau</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GW">GW</a>, GNB,
	 * 624, Officially assigned]
	 */
	GW("Guinea-Bissau", "GNB", 624, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Guyana">Guyana</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#GY">GY</a>, GUY,
	 * 328, Officially assigned]
	 */
	GY("Guyana", "GUY", 328, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Hong_Kong">Hong Kong</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#HK">HK</a>, HKG,
	 * 344, Officially assigned]
	 */
	HK("Hong Kong", "HKG", 344, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Heard_Island_and_McDonald_Islands">Heard Island
	 * and McDonald Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#HM">HM</a>, HMD,
	 * 334, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#HN">HN</a>, HND,
	 * 340, Officially assigned]
	 */
	HN("Honduras", "HND", 340, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Croatia">Croatia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#HR">HR</a>, HRV,
	 * 191, Officially assigned]
	 */
	HR("Croatia", "HRV", 191, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Haiti">Haiti</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#HT">HT</a>, HTI,
	 * 332, Officially assigned]
	 */
	HT("Haiti", "HTI", 332, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Hungary">Hungary</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#HU">HU</a>, HUN,
	 * 348, Officially assigned]
	 */
	HU("Hungary", "HUN", 348, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Canary_Islands">Canary Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#IC">IC</a>, null,
	 * -1, Exceptionally reserved]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ID">ID</a>, IDN,
	 * 360, Officially assigned]
	 */
	ID("Indonesia", "IDN", 360, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Republic_of_Ireland">Ireland</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#IE">IE</a>, IRL,
	 * 372, Officially assigned]
	 */
	IE("Ireland", "IRL", 372, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Israel">Israel</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#IL">IL</a>, ISR,
	 * 376, Officially assigned]
	 */
	IL("Israel", "ISR", 376, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Isle_of_Man">Isle of Man</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#IM">IM</a>, IMN,
	 * 833, Officially assigned]
	 */
	IM("Isle of Man", "IMN", 833, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/India">India</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#IN">IN</a>, IND,
	 * 356, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#JE">JE</a>, JEY,
	 * 832, Officially assigned]
	 */
	JE("Jersey", "JEY", 832, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Jamaica">Jamaica</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#JM">JM</a>, JAM,
	 * 388, Officially assigned]
	 */
	JM("Jamaica", "JAM", 388, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Jordan">Jordan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#JO">JO</a>, JOR,
	 * 400, Officially assigned]
	 */
	JO("Jordan", "JOR", 400, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Japan">Japan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#JP">JP</a>, JPN,
	 * 392, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KE">KE</a>, KEN,
	 * 404, Officially assigned]
	 */
	KE("Kenya", "KEN", 404, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Kyrgyzstan">Kyrgyzstan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KG">KG</a>, KGZ,
	 * 417, Officially assigned]
	 */
	KG("Kyrgyzstan", "KGZ", 417, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Cambodia">Cambodia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KH">KH</a>, KHM,
	 * 116, Officially assigned]
	 */
	KH("Cambodia", "KHM", 116, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Kiribati">Kiribati</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KI">KI</a>, KIR,
	 * 296, Officially assigned]
	 */
	KI("Kiribati", "KIR", 296, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Comoros">Comoros</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KM">KM</a>, COM,
	 * 174, Officially assigned]
	 */
	KM("Comoros", "COM", 174, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Saint_Kitts_and_Nevis">Saint Kitts and
	 * Nevis</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KN">KN</a>, KNA,
	 * 659, Officially assigned]
	 */
	KN("Saint Kitts and Nevis", "KNA", 659, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/North_Korea">Korea, Democratic People's
	 * Republic of</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KP">KP</a>, PRK,
	 * 408, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KR">KR</a>, KOR,
	 * 410, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KW">KW</a>, KWT,
	 * 414, Officially assigned]
	 */
	KW("Kuwait", "KWT", 414, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Cayman_Islands">Cayman Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KY">KY</a>, CYM,
	 * 136, Officially assigned]
	 */
	KY("Cayman Islands", "CYM", 136, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Kazakhstan">Kazakhstan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#KZ">KZ</a>, KAZ,
	 * 398, Officially assigned]
	 */
	 ...
	 * Republic</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#LA">LA</a>, LAO,
	 * 418, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MF">MF</a>, MAF,
	 * 663, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MG">MG</a>, MDG,
	 * 450, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MH">MH</a>, MHL,
	 * 584, Officially assigned]
	 */
	MH("Marshall Islands", "MHL", 584, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Republic_of_Macedonia">Macedonia, the
	 * former Yugoslav Republic of</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MK">MK</a>, MKD,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ML">ML</a>, MLI,
	 * 466, Officially assigned]
	 */
	ML("Mali", "MLI", 466, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Myanmar">Myanmar</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MM">MM</a>, MMR,
	 * 104, Officially assigned]
	 *
	 * @see #BU
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MN">MN</a>, MNG,
	 * 496, Officially assigned]
	 */
	MN("Mongolia", "MNG", 496, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Macau">Macao</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MO">MO</a>, MCO,
	 * 492, Officially assigned]
	 */
	 ...
	 * Mariana Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#MP">MP</a>, MNP,
	 * 580, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#NU">NU</a>, NIU,
	 * 570, Officially assigned]
	 */
	NU("Niue", "NIU", 570, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/New_Zealand">New Zealand</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#NZ">NZ</a>, NZL,
	 * 554, Officially assigned]
	 */
	NZ("New Zealand", "NZL", 554, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href=http://en.wikipedia.org/wiki/Oman"">Oman</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#OM">OM</a>, OMN,
	 * 512, Officially assigned]
	 */
	OM("Oman", "OMN", 512, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Panama">Panama</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PA">PA</a>, PAN,
	 * 591, Officially assigned]
	 */
	PA("Panama", "PAN", 591, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Peru">Peru</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PE">PE</a>, PER,
	 * 604, Officially assigned]
	 */
	PE("Peru", "PER", 604, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/French_Polynesia">French Polynesia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PF">PF</a>, PYF,
	 * 258, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PG">PG</a>, PNG,
	 * 598, Officially assigned]
	 */
	PG("Papua New Guinea", "PNG", 598, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Philippines">Philippines</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PH">PH</a>, PHL,
	 * 608, Officially assigned]
	 */
	PH("Philippines", "PHL", 608, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Pakistan">Pakistan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PK">PK</a>, PAK,
	 * 586, Officially assigned]
	 */
	PK("Pakistan", "PAK", 586, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Poland">Poland</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PL">PL</a>, POL,
	 * 616, Officially assigned]
	 */
	PL("Poland", "POL", 616, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Saint_Pierre_and_Miquelon">Saint Pierre
	 * and Miquelon</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#PM">PM</a>, SPM,
	 * 666, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SB">SB</a>, SLB,
	 * 90, Officially assigned]
	 */
	SB("Solomon Islands", "SLB", 90, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Seychelles">Seychelles</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SC">SC</a>, SYC,
	 * 690, Officially assigned]
	 */
	SC("Seychelles", "SYC", 690, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Sudan">Sudan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SD">SD</a>, SDN,
	 * 729, Officially assigned]
	 */
	SD("Sudan", "SDN", 729, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Sweden">Sweden</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SE">SE</a>, SWE,
	 * 752, Officially assigned]
	 */
	SE("Sweden", "SWE", 752, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Finland">Finland</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SF">SF</a>, FIN,
	 * 246, Traditionally reserved]
	 *
	 * @see #FI
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SG">SG</a>, SGP,
	 * 702, Officially assigned]
	 */
	SG("Singapore", "SGP", 702, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Saint_Helena,_Ascension_and_Tristan_da_Cunha">Saint
	 * Helena, Ascension and Tristan da Cunha</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SH">SH</a>, SHN,
	 * 654, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SI">SI</a>, SVN,
	 * 705, Officially assigned]
	 */
	SI("Slovenia", "SVN", 705, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Svalbard_and_Jan_Mayen">Svalbard and
	 * Jan Mayen</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SJ">SJ</a>, SJM,
	 * 744, Officially assigned]
	 */
	SJ("Svalbard and Jan Mayen", "SJM", 744, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Slovakia">Slovakia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SK">SK</a>, SVK,
	 * 703, Officially assigned]
	 */
	SK("Slovakia", "SVK", 703, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Sierra_Leone">Sierra Leone</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SL">SL</a>, SLE,
	 * 694, Officially assigned]
	 */
	SL("Sierra Leone", "SLE", 694, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/San_Marino">San Marino</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SM">SM</a>, SMR,
	 * 674, Officially assigned]
	 */
	SM("San Marino", "SMR", 674, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Senegal">Senegal</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SN">SN</a>, SEN,
	 * 686, Officially assigned]
	 */
	SN("Senegal", "SEN", 686, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Somalia">Somalia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SO">SO</a>, SOM,
	 * 706, Officially assigned]
	 */
	SO("Somalia", "SOM", 706, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Suriname">Suriname</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SR">SR</a>, SUR,
	 * 740, Officially assigned]
	 */
	SR("Suriname", "SUR", 740, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/South_Sudan">South Sudan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SS">SS</a>, SSD,
	 * 728, Officially assigned]
	 */
	SS("South Sudan", "SSD", 728, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/S%C3%A3o_Tom%C3%A9_and_Pr%C3%ADncipe">Sao Tome
	 * and Principe</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ST">ST</a>, STP,
	 * 678, Officially assigned]
	 */
	ST("Sao Tome and Principe", "STP", 678, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Soviet_Union">USSR</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SU">SU</a>, SUN,
	 * 810, Exceptionally reserved]
	 *
	 * <p>
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SV">SV</a>, SLV,
	 * 222, Officially assigned]
	 */
	 ...
	 * part)</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SX">SX</a>, SXM,
	 * 534, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SY">SY</a>, SYR,
	 * 760, Officially assigned]
	 */
	SY("Syrian Arab Republic", "SYR", 760, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Swaziland">Swaziland</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#SZ">SZ</a>, SWZ,
	 * 748, Officially assigned]
	 */
	SZ("Swaziland", "SWZ", 748, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Tristan_da_Cunha">Tristan da Cunha</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TA">TA</a>, TAA,
	 * -1, Exceptionally reserved.
	 */
	 ...
	 * Caicos Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TC">TC</a>, TCA,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TD">TD</a>, TCD,
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/French_Southern_and_Antarctic_Lands">French
	 * Southern Territories</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TF">TF</a>, ATF,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TG">TG</a>, TGO,
	 * 768, Officially assigned]
	 */
	TG("Togo", "TGO", 768, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Thailand">Thailand</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TH">TH</a>, THA,
	 * 764, Officially assigned]
	 */
	TH("Thailand", "THA", 764, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Tajikistan">Tajikistan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TJ">TJ</a>, TJK,
	 * 762, Officially assigned]
	 */
	TJ("Tajikistan", "TJK", 762, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Tokelau">Tokelau</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TK">TK</a>, TKL,
	 * 772, Officially assigned]
	 */
	TK("Tokelau", "TKL", 772, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/East_Timor">Timor-Leste</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TL">TL</a>, TLS,
	 * 626, Officially assigned]
	 *
	 * @see #TM
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TM">TM</a>, TKM,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TN">TN</a>, TUN,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TO">TO</a>, TON,
	 * 776, Officially assigned]
	 */
	TO("Tonga", "TON", 776, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/East_Timor">East Timor</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TP">TP</a>, TMP,
	 * 626, Traditionally reserved]
	 *
	 * <p>
	 * Since version 1.16, the value of alpha-3 code of this entry is {@code TMP}
	 * (not <code><a href=
	 * "http://en.wikipedia.org/wiki/ISO_3166-3#TPTL">TPTL</a></code>).
	 * </p>
	 *
	 * <p>
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TR">TR</a>, TUR,
	 ...
	 * Tobago</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TT">TT</a>, TTO,
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TV">TV</a>, TUV,
	 * 798, Officially assigned]
	 */
	TV("Tuvalu", "TUV", 798, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Taiwan">Taiwan, Province of China</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TW">TW</a>, TWN,
	 * 158, Officially assigned]
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Tanzania">Tanzania, United Republic
	 * of</a> [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#TZ">TZ</a>,
	 * TZA, 834, Officially assigned]
	 */
	TZ("Tanzania, United Republic of", "TZA", 834, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Ukraine">Ukraine</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#UA">UA</a>, UKR,
	 * 804, Officially assigned]
	 */
	UA("Ukraine", "UKR", 804, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Uganda">Uganda</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#UG">UG</a>, UGA,
	 * 800, Officially assigned]
	 */
	UG("Uganda", "UGA", 800, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/United_Kingdom">United Kingdom</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#UK">UK</a>, null,
	 * 826, Exceptionally reserved]
	 *
	 * <p>
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/United_States_Minor_Outlying_Islands">United
	 * States Minor Outlying Islands</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#UM">UM</a>, UMI,
	 * 581, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#US">US</a>, USA,
	 * 840, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#UY">UY</a>, URY,
	 * 858, Officially assigned]
	 */
	UY("Uruguay", "URY", 858, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Uzbekistan">Uzbekistan</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#UZ">UZ</a>, UZB,
	 * 860, Officially assigned]
	 */
	UZ("Uzbekistan", "UZB", 860, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Vatican_City">Holy See (Vatican City
	 * State)</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#VA">VA</a>, VAT,
	 * 336, Officially assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#VC">VC</a>, VCT,
	 * 670, Officially assigned]
	 */
	VC("Saint Vincent and the Grenadines", "VCT", 670, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Venezuela">Venezuela, Bolivarian
	 * Republic of</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#VE">VE</a>, VEN,
	 * 862, Officially assigned]
	 */
	VE("Venezuela, Bolivarian Republic of", "VEN", 862, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/British_Virgin_Islands">Virgin Islands,
	 * British</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#VG">VG</a>, VGB,
	 * 92, Officially assigned]
	 */
	 ...
	 * Islands, U.S.</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#VI">VI</a>, VIR,
	 * 850, Officially assigned]
	 */
	VI("Virgin Islands, U.S.", "VIR", 850, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Vietnam">Viet Nam</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#VN">VN</a>, VNM,
	 * 704, Officially assigned]
	 */
	VN("Viet Nam", "VNM", 704, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Vanuatu">Vanuatu</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#VU">VU</a>, VUT,
	 * 548, Officially assigned]
	 */
	 ...
	 * Futuna</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#WF">WF</a>, WLF,
	 * 876, Officially assigned]
	 */
	WF("Wallis and Futuna", "WLF", 876, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Samoa">Samoa</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#WS">WS</a>, WSM,
	 * 882, Officially assigned]
	 */
	WS("Samoa", "WSM", 882, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Kosovo">Kosovo, Republic of</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#XK">XK</a>, XXK,
	 * -1, User assigned]
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#YE">YE</a>, YEM,
	 * 887, Officially assigned]
	 */
	YE("Yemen", "YEM", 887, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Mayotte">Mayotte</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#YT">YT</a>, MYT,
	 * 175, Officially assigned]
	 */
	YT("Mayotte", "MYT", 175, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Yugoslavia">Yugoslavia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#YU">YU</a>, YUG,
	 * 890, Traditionally reserved]
	 *
	 * <p>
	 * Since version 1.16, the value of alpha-3 code of this entry is {@code YUG}
	 * (not <code><a href=
	 * "http://en.wikipedia.org/wiki/ISO_3166-3#YUCS">YUCS</a></code>).
	 * </p>
	 */
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ZA">ZA</a>, ZAF,
	 * 710, Officially assigned]
	 */
	ZA("South Africa", "ZAF", 710, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Zambia">Zambia</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ZM">ZM</a>, ZMB,
	 * 894, Officially assigned]
	 */
	ZM("Zambia", "ZMB", 894, Assignment.OFFICIALLY_ASSIGNED),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Zaire">Zaire</a>
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ZR">ZR</a>, ZAR,
	 * 180, Traditionally reserved]
	 *
	 * <p>
	 * Since version 1.16, the value of alpha-3 code of this entry is {@code ZAR}
	 * (not <code><a href=
	 * "http://en.wikipedia.org/wiki/ISO_3166-3#ZRCD">ZRCD</a></code>).
	 * </p>
	 *
	 * <p>
	 ...
	 * [<a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ZW">ZW</a>, ZWE,
	 * 716, Officially assigned]
	 */
	ZW("Zimbabwe", "ZWE", 716, Assignment.OFFICIALLY_ASSIGNED),;

	/**
	 * Code assignment state in
	...
	public enum Assignment {
		 ...
		 * >Not used</a>.
		 *
		 * Not used in ISO 3166-1 in deference to international property organization
		 * names.
		 */
		NOT_USED
	}
	...
	static {
		for (CountryCode cc : values()) {
			...
			if (cc.numeric() != -1) {
				numericMap.put(Integer.valueOf(cc.numeric()), cc);
			}
		}
	...
	private CountryCode(String countryName, String alpha3, int numeric, Assignment assignment) {
	...
	/**
	 * Get the <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" >ISO 3166-1
	 * alpha-2</a> code.
	 *
	 * @return The <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" >ISO
	 *         3166-1 alpha-2</a> code. {@link CountryCode#UNDEFINED} returns
	...
	/**
	 * Get the <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >ISO 3166-1
	 * alpha-3</a> code.
	 *
	 * @return The <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >ISO
	 *         3166-1 alpha-3</a> code. Some country codes reserved exceptionally
	 *         (such as {@link #EU}) returns {@code null}.
	...
	/**
	 * Get the <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric" >ISO 3166-1
	 * numeric</a> code.
	 *
	 * @return The <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric" >ISO
	 *         3166-1 numeric</a> code. Country codes reserved exceptionally (such
	 *         as {@link #EU}) returns {@code -1}. {@link CountryCode#UNDEFINED}
	 *         returns {@code -1}, too.
	 */
	public int numeric() {
		return numeric;
	 ...
	 *
	 * <p>
	 * In most cases, this method creates a new {@code Locale} instance every time
	 * it is called, but some {@code CountryCode} instances return their
	 * corresponding entries in {@code Locale} class. For example, {@link #CA
	 * CountryCode.CA} always returns {@link Locale#CANADA}.
	 * </p>
	 *
	 * <p>
	 * The table below lists {@code CountryCode} entries whose {@code toLocale()} do
	 * not create new Locale instances but return entries in {@code Locale} class.
	 * </p>
	 *
	 ...
	 * {@link Locale#ROOT Locale.ROOT} when it is available (i.e. when the version
	 * of Java SE is 1.6 or higher). Otherwise, it returns a {@code Locale} instance
	 * whose language and country are empty strings. Even in the latter case, the
	 * same instance is returned on every call.
	 * </p>
	 *
	 ...
	 * {@link Currency}{@code .}{@link Currency#getInstance(Locale)
	 * getInstance}{@code (}{@link #toLocale()}{@code )}. The only difference is
	 * that this method returns {@code null} when
	 * {@code Currency.getInstance(Locale)} throws {@code IllegalArgumentException}.
	 * </p>
	 *
	 * <p>
	 ...
	 * implementation of {@link Currency#getInstance(Locale)}. At the time of this
	 * writing, {@link #SS} (South Sudan) is one example.
	 * </p>
	 *
	 ...
	 * getByCode}{@code (code, true)}. Note that the behavior has changed since the
	 * version 1.13. In the older versions, this method was an alias of
	 * {@code getByCode(code, false)}.
	 * </p>
	 *
	 * @param code
	 *            An ISO 3166-1
	 ...
	 *            >alpha-2</a> or
	 *            <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3"
	 *            >alpha-3</a> code. When {@code "UNDEFINED"} is given,
	 *            {@link #UNDEFINED CountryCode.UNDEFINED} is returned. In addition,
	 *            for backward compatibility, some 4-letter
	 *            <a href= "https://en.wikipedia.org/wiki/ISO_3166-3">ISO 3166-3</a>
	 *            codes such as {@code "ANHH"} are accepted.
	 *
	 * @return A {@code CountryCode} instance, or {@code null} if not found.
	 *
	 * @see #getByCode(String, boolean)
	 */
	public static CountryCode byCode(String code) {
	 ...
	 *            >alpha-2</a> or
	 *            <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3"
	 *            >alpha-3</a> code. Or {@code "UNDEFINED"} (case insensitive). In
	 *            addition, for backward compatibility, some 4-letter
	 *            <a href= "https://en.wikipedia.org/wiki/ISO_3166-3">ISO 3166-3</a>
	 *            codes such as {@code "ANHH"} are accepted.
	 *
	 * @return A {@code CountryCode} instance, or {@code null} if not found.
	 ...
	 * @see #getByCode(String, boolean)
	 */
	public static CountryCode byCodeIgnoreCase(String code) {
	 ...
	 *            >alpha-2</a> or
	 *            <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3"
	 *            >alpha-3</a> code. Or {@code "UNDEFINED"} (its case sensitivity
	 *            depends on the value of {@code caseSensitive}). In addition, for
	 *            backward compatibility, some 4-letter
	 *            <a href= "https://en.wikipedia.org/wiki/ISO_3166-3">ISO 3166-3</a>
	 *            codes such as {@code "ANHH"} are accepted.
	 *
	 * @param caseSensitive
	 *            If {@code true}, the given code should consist of upper-case
	 *            letters only. If {@code false}, this method internally
	 *            canonicalizes the given code by {@link String#toUpperCase()} and
	 *            then performs search. For example, {@code getByCode("jp", true)}
	 *            returns {@code null}, but on the other hand,
	 *            {@code getByCode("jp", false)} returns {@link #JP CountryCode.JP}.
	 *
	 * @return A {@code CountryCode} instance, or {@code null} if not found.
	 */
	public static CountryCode byCode(String code, boolean caseSensitive) {
		if (code == null) {
			return null;
		}
		...
		case 3:
			code = canonicalize(code, caseSensitive);
			return byAlpha3Code(code);

		case 4:
			code = canonicalize(code, caseSensitive);
			return byAlpha4Code(code);
	...
	/**
	 * Get a {@code CountryCode} that corresponds to the country code of the given
	 * {@link Locale} instance.
	 *
	 * @param locale
	 *            A {@code Locale} instance.
	 *
	 * @return A {@code CountryCode} instance, or {@code null} if not found. When
	 *         {@link Locale#getCountry() getCountry()} method of the given
	 *         {@code Locale} instance returns {@code null} or an empty string,
	 *         {@link #UNDEFINED CountryCode.UNDEFINED} is returned.
	 *
	 * @see Locale#getCountry()
	 */
	public static CountryCode byLocale(Locale locale) {
		if (locale == null) {
			return null;
		}
		...
		if (country == null || country.length() == 0) {
			throw new IllegalArgumentException("Invalid country code in Locale:" + locale);
		}

		return byCode(country, true);
	}
	 ...
	 *
	 * @return If {@code code} is {@code null} or an empty string, {@code null} is
	 *         returned. Otherwise, if {@code caseSensitive} is {@code true},
	 *         {@code code} is returned as is. Otherwise, {@code code.toUpperCase()}
	 *         is returned.
	 */
	...
	private static CountryCode byAlpha2Code(String code) {
		try {
	...
	private static CountryCode byAlpha3Code(String code) {
		return alpha3Map.get(code);
	}

	private static CountryCode byAlpha4Code(String code) {
	 ...
	 *
	 * @return A {@code CountryCode} instance, or {@code null} if not found. If 0 or
	 *         a negative value is given, {@code null} is returned.
	 */
	public static CountryCode byCode(int code) {
		if (code <= 0) {
			return null;
		}
	 ...
	 *
	 * @return List of {@code CountryCode}. If nothing has matched, an empty list is
	 *         returned.
	 *
	 ...
	 * @since 1.11
	 */
	public static List<CountryCode> byName(String regex) {
		if (regex == null) {
	 ...
	 * @since 1.11
	 */
	public static List<CountryCode> byName(Pattern pattern) {
		if (pattern == null) {
		...
		for (CountryCode entry : values()) {
			...
			if (pattern.matcher(entry.countryName()).matches()) {
				list.add(entry);
			}
		}
